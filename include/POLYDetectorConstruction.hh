...
// ********************************************************************
//
// POLYDetectorConstruction.hh
// \file   MRCP_GEANT4/External/include/POLYDetectorConstruction.hh
// \author Haegin Han
//

#ifndef POLYDetectorConstruction_h
#define POLYDetectorConstruction_h 1
...
class POLYDetectorConstruction : public G4VUserDetectorConstruction
{
public:
	POLYDetectorConstruction(POLYModelImport* POLYData);
	virtual ~POLYDetectorConstruction();
...
private:
	...
	G4int              nOfPOLYrahedrons;
	std::vector<G4LogicalVolume*> logVec;

	G4LogicalVolume*   POLYLogic;
};
