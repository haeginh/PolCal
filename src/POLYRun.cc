...
//
// POLYRun.cc
// \file   MRCP_GEANT4/External/src/POLYRun.cc
// \author Haegin Han
//
...
void POLYRun::RecordEvent(const G4Event* event)
{
	// Hits collections
	//
...
void POLYRun::Merge(const G4Run* run)
{
	// merge the data from each thread
	EDEPMAP localMap = static_cast<const POLYRun*>(run)->edepMap;
